...
function tellJoke(joke) {
    VoiceRSS.speech({
        key: 'ff4f700ad4284e11b35657a470fce56f',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 2, 
...
async function getJoke() {
    toggleButton();
    try {
        const response = await fetch("https://v2.jokeapi.dev/joke/Programming,Miscellaneous,Dark,Pun,Spooky?blacklistFlags=nsfw,sexist,explicit");
        ...
        console.log("The fetch method returned an error", err);
    }
}
